    ...
    render() {
        ...
        return (
            <MainContainer>
                ...
                <div className="row justify-content-md-center mt-3"><h4>Типы полей методов</h4></div>
                ...
                <div className="row mt-4">
                        <table className="table">
                            <tbody>
                                ...
                                {this.state.allFields.length === 0 ? <tr/> : this.state.allFields.map((item, index) => (
                                    <tr key={index}>
                                        <td>{item.id}</td>
                                        <td>{item.title}</td>
                                    </tr>
                    ...
                    <div className="form-row">
                        <button className="btn btn-primary"
                            onClick={() => { window.location.href = "fields/new"; }}>Создать новое поле</button>
                    </div>
                </div>
                </div>
            </MainContainer>
