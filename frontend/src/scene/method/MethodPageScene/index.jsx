    ...
    render() {
        return (
            <MainContainer>
                ...
                <div className="row justify-content-md-center mt-3"><h4>Описание метода</h4></div>
                <div className="row">
                    <div className="col-2">
                ...
                {this.state.method.additionalInfo.map((item, index) => (
                                ...
                                <div className="col-12">
                                        <input className="btn btn-danger"onClick={() => { this.deleteMethod(); }}
                                            type="button"
                                            value="Удалить метод"></input>
                                    </div>
                </div>
            </MainContainer>
        );
