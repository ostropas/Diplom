...
class NewMethodPageScene extends Component {
    ...
    createNewMethod() {
        ...
        methodLocal.additionalInfo = Array.from(methodLocal.additionalInfo).map((val) => {
                ...
                <div className="container">
                    ...
                    <div className="row">
                                ...
                                {this.state.allFields.map((element, index) => (
                                    ...
                                    <div className="col-10">
                                        <input className="form-control" type="text"  id={element.id}
                            ...
                            <div className="form-row">
                                <button className="btn btn-primary" onClick={() => { this.createNewMethod(); }}>Сохранить</button>
                            </div>
                        </div>
                    </div>
                </div>
